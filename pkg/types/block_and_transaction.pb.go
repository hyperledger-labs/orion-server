...
func (m *AugmentedBlockHeader) Reset()         { *m = AugmentedBlockHeader{} }
...
func (m *AugmentedBlockHeader) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AugmentedBlockHeader.Unmarshal(m, b)
}
func (m *AugmentedBlockHeader) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AugmentedBlockHeader.Marshal(b, m, deterministic)
}
func (m *AugmentedBlockHeader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AugmentedBlockHeader.Merge(m, src)
}
func (m *AugmentedBlockHeader) XXX_Size() int {
	return xxx_messageInfo_AugmentedBlockHeader.Size(m)
}
func (m *AugmentedBlockHeader) XXX_DiscardUnknown() {
	xxx_messageInfo_AugmentedBlockHeader.DiscardUnknown(m)
}

var xxx_messageInfo_AugmentedBlockHeader proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AugmentedBlockHeader)(nil), "types.AugmentedBlockHeader")
}
